...
const ScreenReaderOverlay = () => {
  const { hasEntered, isInRoom, currentRoom, teleportTo, requestExit } =
    useScene();
  return (
    <div
      className="sr-overlay"
      role="complementary"
      aria-label="Accessible navigation for 3D portfolio"
    >
      {}
      ...
      <nav id="sr-main-nav" className="sr-only" aria-label="Portfolio rooms">
        ...
        {!hasEntered && (
          <p>
            Welcome to ITom's interactive 3D portfolio. Click or press Enter on
            the doors to enter.
          </p>
        )}
          ...
          <>
            ...
            {currentRoom === "about" && (
              <div aria-label="About room content">
                <h3>About Me</h3>
                <p>
                  This room contains my personal story, awards, journey
                  milestones, and technology skills displayed as interactive
                  balloons.
                </p>
              </div>
            )}
            {currentRoom === "gallery" && (
              <div aria-label="Gallery room content">
                <h3>My Projects</h3>
                <p>
                  Browse through my portfolio projects displayed on paper cards.
                  Click on a project card to see details and visit the live
                  site.
                </p>
              </div>
            )}
            {currentRoom === "contact" && (
              <div aria-label="Contact room content">
                <h3>Contact Me</h3>
                <p>
                  Find my social media links displayed as floating barrels.
                  Click to visit my profiles on LinkedIn, GitHub, and other
                  platforms.
                </p>
              </div>
            )}
            {currentRoom === "studio" && (
              <div aria-label="Studio room content">
                <h3>The Studio</h3>
                <p>
                  Explore my experience and skills on rotating monitors. Click a
                  monitor to read detailed information about my work.
                </p>
              </div>
            )}
