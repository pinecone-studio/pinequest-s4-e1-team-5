...
const AchievementsPanel = ({
  ...
  return <div className={`achievements-panel ${isOpen ? 'open' : ''}`} inert={!isOpen ? true : undefined}>
          ...
          return <div key={achievement.id} className={`achievement-item ${isUnlocked ? 'unlocked' : 'locked'}`}>
                                <div className="achievement-icon">
                                    {isUnlocked ? <svg viewBox="0 0 24 24" className="icon-unlocked">
                                        ...
                                        </svg> : <svg viewBox="0 0 24 24" className="icon-locked">
