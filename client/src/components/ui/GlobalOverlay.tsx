...
const ContentCard = ({
  ...
  return <div className="global-overlay-wrapper" style={{
    position: 'fixed',
    top: 0,
    left: 0,
    width: '100vw',
    ...
    pointerEvents: isOpen ? 'auto' : 'none'
            ...
            {}
            <div className="global-overlay-backdrop-layer" style={{
      position: 'absolute',
      top: 0,
      left: 0,
      width: '100%',
      ...
      alignItems: 'center'
        ...
        ...(content.layout === 'certificate_grid' ? {
      ...
      }} className="studio-paper-card" onClick={e => e.stopPropagation()}>
                    {}
                    <svg className="studio-border-overlay" viewBox="0 0 100 100" preserveAspectRatio="none" style={{
          position: 'absolute',
          top: 0,
          left: 0,
          width: '100%',
          ...
          zIndex: 10
                        ...
                        <path d="M 0 0 L 4 1 L 8 0 L 12 1 L 16 0 L 20 1 L 24 0 L 28 1 L 32 0 L 36 1 L 40 0 L 44 1 L 48 0 L 52 1 L 56 0 L 60 1 L 64 0 L 68 1 L 72 0 L 76 1 L 80 0 L 84 1 L 88 0 L 92 1 L 96 0 L 100 0 L 99 3 L 100 6 L 98 10 L 100 14 L 99 18 L 100 22 L 98 26 L 100 30 L 99 35 L 100 40 L 98 45 L 100 50 L 99 55 L 100 60 L 98 65 L 100 70 L 99 75 L 100 80 L 98 85 L 100 90 L 99 95 L 100 100 L 96 99 L 92 100 L 88 98 L 84 100 L 80 99 L 76 100 L 72 98 L 68 100 L 64 99 L 60 100 L 56 98 L 52 100 L 48 99 L 44 100 L 40 98 L 36 100 L 32 99 L 28 100 L 24 98 L 20 100 L 16 99 L 12 100 L 8 98 L 4 100 L 0 99 L 0.5 99.5 L 1 95 L 0 90 L 2 85 L 0 80 L 1 75 L 0 70 L 2 65 L 0 60 L 1 55 L 0 50 L 2 45 L 0 40 L 1 35 L 0 30 L 2 26 L 0 22 L 1 18 L 0 14 L 2 10 L 0 6 L 1 3 L 0 0 Z" fill="none" stroke="#1a1a1a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" vectorEffect="non-scaling-stroke" />
                    </svg>
          ...
          ...getStaggerStyle(100)
            ...
            gap: '0.2rem'
              ...
              fontFamily: "'Rubik Scribble', cursive"
                    ...
                    {}
                    {content.layout === 'certificate_grid' ? <div style={{
          position: 'relative',
          flex: 1,
          minHeight: 0
        }}>
                            <div ref={scrollContainerRef} className="awards-scroll-container" style={{
            display: 'grid',
            ...
            ...getStaggerStyle(200)
                                ...
                                {content.items?.map((item, index) => <div key={index} style={{
              display: 'flex',
              flexDirection: 'column',
              gap: '0.8rem',
              ...
              borderRadius: '2px 255px 3px 255px / 255px 5px 225px 3px'
            }} onMouseOver={e => e.currentTarget.style.transform = 'translateY(-5px)'} onMouseOut={e => e.currentTarget.style.transform = 'translateY(0)'} onClick={() => window.open(item.url || content.url || '#', '_blank')}>
                                        <div style={{
                position: 'relative',
                width: '100%',
                paddingBottom: '141%',
                ...
                borderRadius: '2px 255px 3px 255px / 255px 5px 225px 3px'
                                            ...
                                            <img src={item.image || 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs='} alt={item.label} loading="lazy" decoding="async" style={{
                  position: 'absolute',
                  top: 0,
                  left: 0,
                  width: '100%',
                ...
                textAlign: 'center'
                  ...
                  fontWeight: 700
                            ...
                            {}
                            {showScrollbar && <div ref={trackRef} className="torn-scroll-track" onClick={handleTrackClick} style={{
            pointerEvents: 'auto'
          }}>
                                    <div className="torn-scroll-line" />
                                    <div ref={thumbRef} className="torn-scroll-thumb" style={{
            ...
            ...getStaggerStyle(400)
                                ...
                                <a href={content.url} target="_blank" rel="noopener noreferrer" className="studio-action-button">
                                    Open Link ↗
                                </a>
                            </div>
                        </>}
