...
const AudioControls = () => {
  ...
  const SoundOnIcon = () => <svg viewBox="0 0 24 24">
            <path d="M11 5L6 9H2v6h4l5 4V5z" strokeWidth="2.5" />
            <path d="M15 9a5 5 0 0 1 0 6" />
            <path d="M18 5a9 9 0 0 1 0 14" />
        </svg>;
  const SoundOffIcon = () => <svg viewBox="0 0 24 24">
            <path d="M11 5L6 9H2v6h4l5 4V5z" strokeWidth="2.5" />
  ...
  return <div className="audio-controls">
            ...
            <div className="volume-slider-container">
                <input type="range" min="0" max="1" step="0.01" value={globalVolume} onChange={e => setGlobalVolume(parseFloat(e.target.value))} aria-label="Volume" />
            </div>
