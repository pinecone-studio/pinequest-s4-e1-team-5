...
const SchoolAssistant = () => {
  ...
  const sideClass =
    schoolAssistantPlacement?.side === "right"
      ? "school-assistant--right"
      : "school-assistant--left";

  return (
    <div
      className={`school-assistant ${sideClass}`}
      role="dialog"
      aria-modal="true"
      ...
      <section className="school-assistant__stage" ref={panelRef}>
        ...
        <div className="school-assistant__content">
          <div className="school-assistant__bubble">
            ...
            <h2 id="school-assistant-title">HELLO!</h2>
            <p className="school-assistant__message">
              Өрөө рүү орохын өмнө түвшнээ сонгоорой.
            </p>
          </div>

          <div
            className="school-assistant__choices"
            aria-label="Ангийн түвшин сонгох"
          >
            {LEVEL_OPTIONS.map((option, index) => (
              ...
              >
                <span className="school-assistant__choice-number">
                  {option.number}
                </span>
