...
const GalleryClouds = ({
  ...
  return <group>
            {clouds.map(cloud => <StaticCloud key={cloud.id} position={cloud.position} scale={cloud.scale} opacity={cloud.opacity} textureIndex={cloud.textureIndex} driftSpeed={cloud.driftSpeed} initialOffset={cloud.initialOffset} rotationOffset={rotationOffset} />)}
        </group>;
};
const StaticCloud = ({
  position,
