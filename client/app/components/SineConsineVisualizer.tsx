...
function ChalkboardTrigVisualizer() {
  ...
  const featureNote = createFeatureNote(selectedFeature, selectedAngle, thetaDeg);
    ...
    <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white text-slate-950 shadow-sm">
      ...
      <div className="bg-[#f7f8fb] p-3 sm:p-5">
        ...
        >
          ...
          <rect width={boardWidth} height={boardHeight} rx="24" fill="#ffffff" />
          ...
          <text x={waveEndX + 48} y={circleCenterY + 11} className="fill-slate-950 text-[34px]">
            t
          </text>
          <text x={circleCenterX - 49} y="117" className="fill-slate-700 text-[24px]">
            π
          </text>
          <text x={circleCenterX - 58} y="267" className="fill-slate-700 text-[24px]">
            2π
          </text>
          <line x1={circleCenterX - 5} y1="106" x2={circleCenterX + 12} y2="106" stroke="#334155" strokeWidth="1.4" />
          <line x1={circleCenterX - 5} y1="260" x2={circleCenterX + 12} y2="260" stroke="#334155" strokeWidth="1.4" />
          ...
          <text x={circleCenterX - 7} y={circleCenterY + 10} className="fill-slate-600 text-[16px]">
            0
          </text>
          ...
          <path
            d={fullSinePath}
            fill="none"
            stroke={selectedFeature === "sin" ? "rgba(8,145,178,0.34)" : "rgba(15,23,42,0.12)"}
            strokeLinecap="round"
          ...
          <path
            d={fullCosinePath}
            fill="none"
            stroke={selectedFeature === "cos" ? "rgba(15,23,42,0.34)" : "rgba(15,23,42,0.12)"}
          ...
          <path
            ...
            fill="none"
            stroke={selectedFeature === "cos" ? "rgba(15,23,42,0.86)" : "rgba(15,23,42,0.36)"}
          ...
          <line
            ...
            x2={pointX}
            y2={pointY}
            stroke={selectedFeature === "cos" ? "#0f172a" : "rgba(15,23,42,0.5)"}
          ...
          <line
            ...
            x2={pointX}
            y2={pointY}
            stroke={selectedFeature === "sin" ? "#0891b2" : "rgba(15,23,42,0.5)"}
          ...
          <text x={waveStartX - 8} y={circleCenterY + 31} className="fill-slate-700 text-[24px]">
            0
          </text>
          <text x={(waveStartX + waveEndX) / 2 - 12} y={circleCenterY + 31} className="fill-slate-700 text-[24px]">
            π
          </text>
          <text x={waveEndX - 18} y={circleCenterY + 31} className="fill-slate-700 text-[24px]">
            2π
          </text>
          <line x1={(waveStartX + waveEndX) / 2} y1={circleCenterY - 7} x2={(waveStartX + waveEndX) / 2} y2={circleCenterY + 8} stroke="#334155" strokeWidth="1.5" />
          <line x1={waveEndX} y1={circleCenterY - 7} x2={waveEndX} y2={circleCenterY + 8} stroke="#334155" strokeWidth="1.5" />
          <g>
            <circle cx={waveStartX + 16} cy="58" r="4" fill="#0891b2" />
            <text x={waveStartX + 28} y="64" className="fill-slate-700 text-[16px]">
              sin θ
            </text>
            <line x1={waveStartX + 86} y1="58" x2={waveStartX + 125} y2="58" stroke="#0f172a" strokeDasharray="8 8" strokeWidth="2" />
            <text x={waveStartX + 135} y="64" className="fill-slate-600 text-[16px]">
              cos θ
            </text>
          </g>
        </svg>
        ...
        <div className="grid gap-4 border-t border-slate-200 px-2 py-4 lg:grid-cols-[1fr_440px]">
          <div className="grid gap-3 sm:grid-cols-4">
            <DarkValueCard label="θ градус" value={`${Math.round(thetaDeg)}°`} />
        ...
        <div className="relative grid gap-4 p-4 lg:grid-cols-[260px_minmax(330px,1fr)_minmax(330px,1fr)] lg:p-5">
          ...
          <div className="rounded-3xl border border-cyan-100/15 bg-white/[0.045] p-4 shadow-2xl shadow-cyan-950/30 backdrop-blur">
            ...
            >
              ...
              <rect width={labWidth} height={labHeight} rx="22" fill="rgba(2,6,23,0.54)" />
              <g transform={`translate(${labCenterX} ${labCenterY}) scale(1 ${labYScale})`}>
                <circle
                  className="lab-orbit"
                  cx="0"
                  cy="0"
              ...
              {[
                ...
                const y = labCenterY - Math.sin(markerRad) * labRadius * labYScale;
              ...
              <circle cx={pointX} cy={pointY} r="18" fill="url(#pointGlow3d)" opacity="0.5" />
              <circle
                cx={pointX}
                cy={pointY}
                r="7"
          ...
          <div className="rounded-3xl border border-fuchsia-100/15 bg-white/[0.045] p-4 shadow-2xl shadow-fuchsia-950/20 backdrop-blur">
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-950/55 p-2">
              ...
              >
                ...
                <rect width={graphWidth} height={graphHeight} rx="22" fill="rgba(2,6,23,0.9)" />
                <rect width={graphWidth} height={graphHeight} rx="22" fill="url(#graphGrid3d)" />
                <line
                  x1={graphPadding}
                  y1={graphHeight / 2}
                ...
                <line
                  ...
                  strokeWidth="1.5"
                />
                <circle cx={waveX} cy={sineY} r="11" fill="#d946ef" opacity="0.18" filter="url(#waveHeadGlow3d)" />
                <circle cx={waveX} cy={sineY} r="5.6" fill="#d946ef" filter="url(#waveNeon3d)" />
                <circle cx={waveX} cy={cosineY} r="11" fill="#22d3ee" opacity="0.18" filter="url(#waveHeadGlow3d)" />
                <circle cx={waveX} cy={cosineY} r="5.6" fill="#22d3ee" filter="url(#waveNeon3d)" />
                <g>
                  <rect x={graphPadding - 4} y="9" width="104" height="20" rx="10" fill="rgba(2,6,23,0.72)" />
                  <circle cx={graphPadding + 10} cy="19" r="3" fill="#d946ef" />
                  <text x={graphPadding + 18} y="23" className="fill-fuchsia-100 text-[10px]">
                    sin θ
                  </text>
                  <circle cx={graphPadding + 62} cy="19" r="3" fill="#22d3ee" />
                  <text x={graphPadding + 70} y="23" className="fill-cyan-100 text-[10px]">
                    cos θ
                  </text>
                </g>
              </svg>
        ...
        <div className="relative border-t border-white/10 bg-slate-950/55 p-4 lg:p-5">
          ...
          <div className="grid gap-4 xl:grid-cols-[1fr_420px]">
            <div className="grid gap-3 sm:grid-cols-4">
              <DarkValueCard label="θ градус" value={`${Math.round(thetaDeg)}°`} />
              <DarkValueCard label="θ радиан" value={thetaRad.toFixed(3)} />
              <DarkValueCard label="sin θ" value={sinValue.toFixed(3)} tone="sin" />
              <DarkValueCard label="cos θ" value={cosValue.toFixed(3)} tone="cos" />
            </div>
...
export function SineCosineVisualizer2D() {
  ...
  const waveX =
    wavePadding + (thetaDeg / 360) * (waveWidth - wavePadding * 2);
    ...
    <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white text-slate-950 shadow-sm">
          ...
          <div className="flex items-center gap-4 rounded-3xl border border-slate-200 bg-slate-50 px-4 py-3">
            <div className="teacher-marker grid h-12 w-12 shrink-0 place-items-center rounded-full border border-cyan-200 bg-white text-cyan-700 shadow-sm">
              <svg viewBox="0 0 48 48" className="h-9 w-9" aria-hidden="true">
                <circle cx="24" cy="16" r="7" fill="none" stroke="currentColor" strokeWidth="2" />
                <path
                  ...
                  strokeWidth="2"
                />
                <path d="M33 14l7-6" stroke="#0f172a" strokeLinecap="round" strokeWidth="2" />
              </svg>
            </div>
            <div>
      ...
      <div className="grid gap-6 bg-[#f7f8fb] p-5 lg:grid-cols-[320px_1fr] lg:p-6">
        <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          >
            <defs>
              <pattern id="circleGrid" width="28" height="28" patternUnits="userSpaceOnUse">
                <path
                  d="M 28 0 L 0 0 0 28"
                  fill="none"
            ...
            <rect width={circleSize} height={circleSize} rx="18" fill="#f8fafc" />
            <rect width={circleSize} height={circleSize} rx="18" fill="url(#circleGrid)" />
            <line x1={center} y1={22} x2={center} y2={circleSize - 22} stroke="rgba(15,23,42,0.18)" strokeWidth="1" />
            <line x1={22} y1={center} x2={circleSize - 22} y2={center} stroke="rgba(15,23,42,0.18)" strokeWidth="1" />
            ...
            <line className="soft-pulse" x1={center} y1={center} x2={pointX} y2={pointY} stroke="#0f172a" strokeLinecap="round" strokeWidth="2" />
            <g>
              <line x1={center} y1={pointY} x2={pointX} y2={pointY} stroke="#0891b2" strokeWidth="1.5" strokeDasharray="5 6" filter="url(#lineGlow)" />
              <line x1={pointX} y1={center} x2={pointX} y2={pointY} stroke="#64748b" strokeWidth="1.3" strokeDasharray="5 6" />
              <text x={(center + pointX) / 2} y={pointY - 8} textAnchor="middle" className="fill-cyan-700 text-[10px]">
                cos θ буюу хэвтээ
              </text>
              <text x={pointX + 10} y={(center + pointY) / 2} className="fill-slate-600 text-[10px]">
                sin θ буюу босоо
              </text>
            </g>
            <circle cx={center} cy={center} r="3.6" fill="#0f172a" />
            <circle cx={pointX} cy={pointY} r="6" fill="#ffffff" stroke="#0891b2" strokeWidth="2.2" filter="url(#lineGlow)" />
          </svg>
        ...
        <div className="space-y-5">
          <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            >
              <defs>
                <pattern id="waveGrid" width="44" height="34" patternUnits="userSpaceOnUse">
                  <path
                    d="M 44 0 L 0 0 0 34"
                    fill="none"
                    stroke="rgba(15,23,42,0.055)"
                ...
                <clipPath id="waveTraceClip">
                  <rect x={wavePadding} y="0" width={traceWidth} height={waveHeight} />
                </clipPath>
              </defs>

              <rect width={waveWidth} height={waveHeight} rx="18" fill="#f8fafc" />
              <rect width={waveWidth} height={waveHeight} rx="18" fill="url(#waveGrid)" />
              <line x1={wavePadding} y1={waveHeight / 2} x2={waveWidth - wavePadding} y2={waveHeight / 2} stroke="rgba(15,23,42,0.2)" strokeWidth="1" />
              {[0, 90, 180, 270, 360].map((angle) => {
                const x =
                  wavePadding + (angle / 360) * (waveWidth - wavePadding * 2);
                return (
                  <g key={angle}>
                    <line x1={x} y1={28} x2={x} y2={waveHeight - 30} stroke="rgba(15,23,42,0.08)" />
                    <text x={x} y={waveHeight - 9} textAnchor="middle" className="fill-slate-500 text-[10px]">
                      {angle}°
                    </text>
                  </g>
                );
              ...
              <path d={createWavePath(Math.sin)} fill="none" stroke="rgba(8,145,178,0.16)" strokeWidth="2" />
              <path d={createWavePath(Math.cos)} fill="none" stroke="rgba(15,23,42,0.14)" strokeWidth="2" />
              <g clipPath="url(#waveTraceClip)">
                <path d={createWavePath(Math.sin)} fill="none" stroke="#0891b2" strokeLinecap="round" strokeWidth="2.5" filter="url(#waveLineGlow)" />
                <path d={createWavePath(Math.cos)} fill="none" stroke="#0f172a" strokeLinecap="round" strokeWidth="2.2" />
              </g>
              <line x1={waveX} y1={26} x2={waveX} y2={waveHeight - 30} stroke="rgba(15,23,42,0.42)" strokeDasharray="4 6" />
              <circle cx={waveX} cy={sineY} r="4.8" fill="#0891b2" />
              <circle cx={waveX} cy={cosineY} r="4.8" fill="#ffffff" stroke="#0f172a" strokeWidth="1.6" />
              <text x={wavePadding} y="18" className="fill-cyan-700 text-[11px]">
                sin θ
              </text>
              <text x={wavePadding + 54} y="18" className="fill-slate-700 text-[11px]">
                cos θ
              </text>
            </svg>
          </div>
          ...
          <AngleSlider thetaDeg={thetaDeg} setThetaDeg={setThetaDeg} setIsPlaying={setIsPlaying} dark={false} />
            ...
            {trigTableAngles.map((angle) => (
              <th
                ...
                className={`border-l border-slate-200 p-0 text-lg font-semibold ${
                  selectedAngle === angle || isActiveTableAngle(activeAngle, angle)
            ...
            <tr key={row} className="border-b border-slate-200 last:border-b-0">
              <th
                className={`p-0 text-left text-2xl font-semibold capitalize ${
                  selectedFeature === row ? "bg-slate-950 text-white" : "text-slate-800"
                }`}
              >
                <button
                  type="button"
...
function findKeyAngle(angle: number) {
  return trigTableAngles.find((keyAngle) => isActiveTableAngle(angle, keyAngle)) ?? null;
}

function trigTableValue(
  angle: number,
  row: TrigTableRow,
) {
